...
namespace DotBPE.Rpc.Client {
    public class DefaultTransportFactory<TMessage> : ITransportFactory<TMessage> where TMessage : InvokeMessage {
        ...
        private readonly Dictionary<string, Lazy<ITransport<TMessage>> > _clients = new Dictionary<string, Lazy<ITransport<TMessage>> > ();
        ...
        private void Bootstrap_Disconnected (object sender, ConnectionEventArgs args) {
            var removed = RemoveTransport (args.RemotePoint, out var _);
        }
